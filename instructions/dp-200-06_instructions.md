...
1. 정책이 만들어지면 새 정책 **xx-phoneanalysis-eh-sap**을 클릭합니다. 그런 다음 **연결 문자열 - 기본 키**의 복사 단추를 선택하고 연결 문자열 - 기본 키를 메모장에 붙여넣습니다. 이 값은 나중에 연습에서 필요합니다.
...
1. 완료되면 **PhoneStream** 입력 작업이 입력 창 아래에 표시됩니다. 입력 창을 닫고 리소스 그룹 페이지로 돌아갑니다.
