...
**필수 구성 요소**: 이 랩 관련 사례 연구의 내용을 확인했으며, 모듈 1~7의 랩과 내용도 확인했다고 가정합니다.

**랩 파일**: 이 랩의 파일은 _Allfiles\Labfiles\Starter\DP-200.8_ 폴더에 있습니다.

## 랩 개요

이 랩을 완료하면 학생들은 심층 방어 제공을 위해 사용할 수 있는 다양한 보안 방식을 설명하고 문서로 작성할 수 있게 됩니다. 여기에는 과정에서 지금까지 설정된 보안을 문서화하는 학생이 포함됩니다. 또한 학생들은 AdventureWorks에 존재할 수 있는 보안의 격차를 식별할 수 있습니다.
...
> **결과**: Azure 구독의 데이터 및 스토리지 보안 관련 약점을 파악할 수 있는 위치를 확인하여 이 연습을 완료했습니다.
...
1. Azure Blob용으로 적절한 보안 방식 결정

1. 강사와 조사 결과에 대해 토론합니다.

### 태스크 1: Azure Blob용으로 적절한 보안 방식 결정
...
1. **SQL Server Management Studio**의 개체 탐색기에서 **DeptDatabasesxx**, **테이블**을 차례로 확장합니다.
...
> **결과**: 데이터베이스 감사를 사용하도록 설정하고 감사가 작동함을 확인하여 이 연습을 완료했습니다.
...
> **결과**: 이벤트 허브 공유 액세스 정책의 보안을 수정하여 이 연습을 완료했습니다.