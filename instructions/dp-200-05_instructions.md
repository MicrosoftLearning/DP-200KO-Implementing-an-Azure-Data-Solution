...
**랩 파일**: 이 랩의 파일은 _Allfiles\Labfiles\Starter\DP-200.5_폴더에 위치해있습니다.
...
1. **SQL Database 만들기** 블레이드에서 다음 설정을 사용하여 Azure SQL Database를 만듭니다.
    ...
    - 데이터베이스 이름: **DeptDatabasesxx**, 여기서 **xx** 는 이니셜입니다.

    - 서버: 다음 설정을 사용하여 새 서버를 만들고 **선택** 을 클릭합니다.
...
### 작업 1: SQL Data Warehouse 인스턴스를 만들고 구성합니다.
...
1. **SQL Data Warehouse** 블레이드에서 다음 설정을 사용하여 Azure SQL Database를 만듭니다.
...
1. 블레이드의 Azure Portal에서 **리소스 그룹을** 클릭한 다음 **awrgstudxx**를 클릭하고 **awdlsstudxx** 를 클릭합니다. 여기에서 **xx** 는 이니셜을 나타냅니다.
...
1. SQL 서버 관리 스튜디오를 설치하고 SQL Data Warehouse 인스턴스에 연결합니다.
...
### 작업 1: SQL 서버 관리 스튜디오를 설치하고 SQL Data Warehouse 인스턴스에 연결합니다.
...
1. **SQL 서버 관리 스튜디오** 에서 **실행** 을 클릭합니다.
...
1. Azure Databricks의 PolyBase를 사용하는 dbo.Preferences 테이블 만들기
...
1. **awsastudxx** 화면에서 **액세스 키** 를 클릭합니다. **스토리지 계정 이름** 옆에 있는 아이콘을 클릭하고 메모장에 붙여 넣습니다.

1. **awsastudxx - 액세스 키** 화면의 **키1** 아래에서 **키** 옆에 있는 아이콘을 클릭하고 메모장에 붙여 넣습니다.
...
1. **SQL Server 관리 스튜디오** 에서 설명문을 강조 표시한 다음 **실행** 을 클릭합니다.
...
1. 테이블에 대해 선택 설명문을 실행하여 테이블이 생성되었는지 테스트합니다.
