...
4. **awrgstudxx** 화면에서 **awdbwsstudxx**를 클릭합니다. 여기서 **xx**는 Azure Databricks를 여는 이니셜입니다. 그러면 Azure Databricks 서비스가 열립니다.
...
2. Notebook의 **Cmd 2** 셀에서 다음 코드를 복사하여 다음 셀에 붙여넣습니다.
